...
2. Explain that installation will register this repository as a local Codex marketplace and update the current user's Codex configuration and plugin cache.
